    ...
    <div class="row">
        <div class="navcontainer large-12 columns">
            <nav class="top-bar" data-topbar>
                <ul class="title-area">
            	<?php if( get_theme_mod( 'ommu_nav_title' ) == 'yes') { ?>
                    <li class="name">
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo get_theme_mod( 'ommu_nav_text' ); ?>" rel="home"><?php echo get_theme_mod( 'ommu_nav_text' ); ?></a>
                    </li>
                <?php } else { ?>
                    <li class="name">
...
<?php if( get_theme_mod( 'ommu_nav_position' ) == 'top') { ?>
    <div class="<?php echo get_theme_mod( 'ommu_nav_display' ); ?>">
        <nav class="top-bar" data-topbar>
            <ul class="title-area">
            	<?php if( get_theme_mod( 'ommu_nav_title' ) == 'yes') { ?>
                    <li class="name">

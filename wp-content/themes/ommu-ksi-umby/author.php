		...
		<div class="content" id="<?php echo $class;?>">    
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php if ( get_the_author_meta( 'description' ) ) : ?>		
					<?php printf( __( 'Author Archives', 'ommu_notoboso' )); ?>
				<?php else : ?>
					<?php printf( __( 'Author Archives: %s', 'ommu_notoboso' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?>
				<?php endif; ?>
				</h1>
